# Data taken from https://iso639-3.sil.org/code_tables/download_tables
...
# Dump of table iso_lang_codes
# ------------------------------------------------------------

DROP TABLE IF EXISTS `iso_lang_codes`;

CREATE TABLE `iso_lang_codes` (
  `id` char(3) NOT NULL DEFAULT '' COMMENT 'ISO 639-3 code',
  `part2b` char(3) DEFAULT NULL COMMENT 'ISO 639-2B code',
  `part2t` char(3) DEFAULT NULL COMMENT 'ISO 639-2T code',
  `part1` char(2) DEFAULT NULL COMMENT 'ISO 639-1 code',
  `scope` char(1) NOT NULL DEFAULT '' COMMENT 'I(ndividual), M(acrolanguage), S(pecial)',
  `type` char(1) NOT NULL DEFAULT '' COMMENT 'A(ncient), C(onstructed), E(xtinct), H(istorical), L(iving), S(pecial)',
  `name` varchar(150) NOT NULL DEFAULT '' COMMENT 'Reference language name',
  `comment` varchar(150) DEFAULT NULL COMMENT 'Comment relating to one or more of the columns',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `iso_lang_codes` WRITE;
/*!40000 ALTER TABLE `iso_lang_codes` DISABLE KEYS */;

INSERT INTO `iso_lang_codes` (`id`, `part2b`, `part2t`, `part1`, `scope`, `type`, `name`, `comment`)
VALUES
	('aaa','','','','I','L','Ghotuo',''),
	('aab','','','','I','L','Alumu-Tesu',''),
	('aac','','','','I','L','Ari',''),
...
VALUES
	...
	('zzj','','','','I','L','Zuojiang Zhuang',NULL);

/*!40000 ALTER TABLE `iso_lang_codes` ENABLE KEYS */;
UNLOCK TABLES;
